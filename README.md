...
(6, '2023_04_18_160737_create_regions_table', 1),
(7, '2023_04_18_160803_create_categories_table', 1),
(8, '2023_04_18_160848_create_items_table', 1),
(9, '2023_04_18_160910_create_orders_table', 1),
(10, '2023_04_18_160947_create_item_images_table', 1),
(11, '2023_04_25_211456_create_posts_table', 2),
(12, '2023_04_25_211724_create_pictures_table', 2),
(13, '2023_04_25_211825_create_likes_table', 2),
(14, '2023_04_25_211916_create_comments_table', 2);
...
ALTER TABLE `items`
  ...
  ADD KEY `items_region_id_foreign` (`region_id`),
...
ALTER TABLE `items`
  ...
  ADD CONSTRAINT `items_region_id_foreign` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `items_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
